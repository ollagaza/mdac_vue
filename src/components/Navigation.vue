  ...
  <div>
    ...
    <template v-else-if="c_navview === 'center'">
      <nav class="navigation">
        <div>
          <div v-on:click="routeMain" style="text-align: center;cursor: pointer; padding-top: 30px;"><img src="@/assets/img/logo.png"></div>
        </div>
      </nav>
    </template>
    <template v-else>
      <nav class="navigation" >
        <div class="nav_box">
          <div class="logo" v-on:click="routeMain"><img src="@/assets/MDC/main_logo.png"></div>
          <div class="nav_sp">
