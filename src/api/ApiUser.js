...
export default {
  ...
  getUserList: (page, is_used, search_type, keyword, member_seq) => request({
    url: `/users/userinfo?page=${page}&is_used=${is_used}&search_type=${search_type}&keyword=${keyword}&member_seq=${member_seq}`,
    method: 'get',
  }),
